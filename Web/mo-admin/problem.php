...
<div class="container">
    ...
    echo $_GET['pid'];
	             ...
	             <input type="text" name="title" class="form-control" placeholder="标题" value="<?php if (isset($_GET['title'])) {
    echo $_GET['title'];
}?>">
	        </div>
					<div class="input-group">
						<span class="input-group-addon glyphicon glyphicon-tags"></span>
	             <input type="text" name="tag" class="form-control" placeholder="标签" value="<?php if (isset($_GET['tag'])) {
    echo $_GET['tag'];
}?>">
	        </div>
